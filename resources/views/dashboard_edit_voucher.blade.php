            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="card-body">
                        <h2>Edit Diskon</h2>
                        <div class="container">
                            <form action="{{route('voucher.update', $edit->id)}}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="form-group row align-items-center mb-4">
                                    <div class="col">
                                        <label for="nama_edit">Nama Diskon</label>
                                    </div>
                                    <div class="col-12 col-md">
                                        <input type="text" required class="form-control" id="nama_edit" name="nama_edit" value="{{ $edit->nama_voucher }}" />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-4">
                                    <div class="col">
                                        <label for="telp_edit">Harga Diskon</label>
                                    </div>
                                    <div class="col-12 col-md">
